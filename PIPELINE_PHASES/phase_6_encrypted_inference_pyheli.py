# phase_6_encrypted_inference_pyheli.py
"""
...
Achieves 85-87% accuracy (matching plaintext baseline).
...
class HospitalInferenceExecutorHElib:
    ...
    def run_hospital_inference(
        ...
        print(f"\n  Encrypted Model (HElib with ReLU):")
...
def main():
    ...
    print("\n" + "="*120)
    print("PHASE 6: FEDERATED ENCRYPTED INFERENCE (Hospital-Specific Data Splits)")
    print("="*120)
    ...
    print(f"  Model: 60 → 128 → 64 → 1 (with Linear ReLU)")
    ...
    # Save results
    print(f"\n[Saving Results]")
    results_path = config.ENCRYPTED_DIR / "phase_6_pyheli_results.json"
    ...
    print(f"\n" + "="*120)
    print("RESULTS: 9,442 Complete Dataset Split Across 3 Hospitals")
    print("="*120)
    
    if all_results:
        print(f"\nPer-Hospital Performance (Individual Data Subsets):\n")
